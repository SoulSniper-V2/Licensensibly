    ...
    <div className="bg-white dark:bg-zinc-950">
      ...
      <section className="mx-auto max-w-[1200px] px-6 pt-14 md:pt-20 pb-10">
        <div className="grid lg:grid-cols-[1.15fr_0.85fr] gap-10 items-start">
          ...
          <div className="rounded-[24px] border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-4 shadow-sm">
            <div className="rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 overflow-hidden">
              ...
              <div className="p-5 space-y-4">
                ...
                <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-3 mono text-xs">
